                ...
                "parameters": [
                    {
                        ...
                        "description": "书源章节聚合键（可传多个，返回并集；最多 50 个，单键最长 2048）",
                        "name": "chapter_url",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "书名（配合 chapter_url 二次过滤，或单独过滤全书）",
                        "name": "book_name",
                        "in": "query"
                    },
                    {
